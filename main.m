...
tic
% Read image
retinaRGB = imread('C:\Users\SHRUTI\Desktop\Project\diabetic-retinopathy-master\Image processing\16_left.jpeg');
% Resize image
...
tic
fileName = 'C:\Users\SHRUTI\Desktop\Project\diabetic-retinopathy-master\Image processing\16_left.jpeg';    
% Read image
retinaRGB = imread(fileName);
% Resize image
retinaRGB = resizeretina(retinaRGB, 752, 500);
% Read optic disc mask
opticDiscMask = imread(strrep(fileName, '.jpeg', '.png'));
xx = double(opticDiscMask);
z = mesh(xx);
artifactsMask = imread(strrep(fileName, '.jpeg', '.png'));
...
% % Load red lesions, exudates and optic disc mask
 fileName = 'C:\Users\SHRUTI\Desktop\Project\diabetic-retinopathy-master\Image processing\16_left.jpeg';  % 225_left
 exudates = imread(strrep(fileName, '.jpeg', '_exudates.png'));
...
featuresExudates = getlesions_feature5(exudates, opticDisc);
...
% % 12. Optic disc distance from center
 opticDistance = getopticdistance_feature6(opticDisc);
